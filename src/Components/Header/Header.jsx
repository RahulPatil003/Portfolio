      ...
      <nav className="nav container">
        ...
        "nav__menu" }>
            <ul className="nav__list grid">
                ...
                <li className="nav__item">
                    <a href="#about" onClick={()=> setActiveNav("#about")} className={activeNav === "#abput" ? "nav__link active__link": "nav__link"} >
                ...
                <li className="nav__item">
                    <a href="#contact" onClick={()=> setActiveNav("#home")} className={activeNav === "#home" ? "nav__link active__link": "nav__link"}>
